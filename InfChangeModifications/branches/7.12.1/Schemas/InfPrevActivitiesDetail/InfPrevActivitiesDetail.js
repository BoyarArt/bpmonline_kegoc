define("InfPrevActivitiesDetail", ["ConfigurationEnums"], function(configurationEnums) {
	return {
		...
		methods: {
			...
			openDocumentLookup: function() {
				...
				var filterCurrentActivity = this.Terrasoft.createColumnFilterWithParameter(
						this.Terrasoft.ComparisonType.NOT_EQUAL,
						"Id",
						ActivityId
					);
				FilterGroup.addItem(filterCurrentActivity);
				...
				esq.addColumn("PrevActivity.Id", "PrevActivityId");
				...
				esq.getEntityCollection(function(result) {
					...
					if (result.success) {
						result.collection.each(function(item) {
							existsActivityCollection.push(item.get("PrevActivityId"));
						});
					}
			...
			addCallBack: function(args) {
				...
				this.selectedRows.forEach(function(item) {
					...
					item.PrevActivityId = item.value;
			...
			getDocumentInsertQuery: function(item) {
				...
				insert.setParameterValue("PrevActivity", item.PrevActivityId, this.Terrasoft.DataValueType.GUID);
				return insert;
			},

	...
	return {
		...
		methods: {
			...
			getSectionActions: function() {
				...
				actionMenuItems.addItem(this.getButtonMenuItem({
					"Caption": {bindTo: "Resources.Strings.GenerateReport"},
					"Click": {bindTo: "generateReportPageInit"},
					"Enabled": true
				}));
				return actionMenuItems;
			},
			generateReportPageInit: function() {
				var token = "CardModuleV2/GetParamReport/edit/" + Terrasoft.generateGUID();
